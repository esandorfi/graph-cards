...
import { createTestMarkdown, expectCardHasLinks, expectCardHasTags } from '../utils/test-helpers';
...
describe('MarkdownParser', () => {
  ...
  describe('parseContent', () => {
    ...
    it('should sanitize IDs correctly', () => {
      const content = '# Card With Spaces & Special Characters!\n\nContent here.';
